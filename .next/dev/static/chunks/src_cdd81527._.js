...
"[project]/src/components/sections/Terminal.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const Terminal = ({ className })=>{
    ...
    const handleCommand = (e)=>{
        ...
        if (cmd === "clear") {
            setOutput([]);
        } else if (__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TERMINAL_COMMANDS"][cmd]) {
            newOutput.push(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TERMINAL_COMMANDS"][cmd]);
            setOutput(newOutput);
        } else if (cmd !== "") {
...
_s(Terminal, "npqpH/dVj3hTr13+kUwuKNvinaQ=");
_c = Terminal;
var _c;
...
//# sourceMappingURL=src_cdd81527._.js.map